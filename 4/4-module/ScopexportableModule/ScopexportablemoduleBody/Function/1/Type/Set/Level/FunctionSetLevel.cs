...
namespace Core
{
    ...
    public partial class ScopexportablemoduleBody
    {
        ...
        {
            public static IList<ScopexportablelevelBodyX_pqrstY> FunctionLevelSet(Scopexportableextractform[] array_SCOPEXPORTABLEEXTRACTFORM, Object[] array_OBJECT)
            {
                ...
                foreach (Scopexportableextractform scopexportableextractform in array_SCOPEXPORTABLEEXTRACTFORM)
                {
