...
namespace Core
{
    ...
    public partial class ScopexportablemoduleBody
    {
        ...
        {
            public static IList<ScopexportablelevelBodyXop_rstY> FunctionLevelSet(ScopexportablelevelBodyXo_qrstY[] Level_ARRAY, Scopexportableheadersolid[] array_SCOPEXPORTABLEHEADERSOLID)
            {
