...
namespace Core
{
    ...
    public partial class ScopexportablemoduleBody
    {
        ...
        {
            public static ScopexportablelevelBodyXopqrs_Y[] FunctionLevelSetSurface(ScopexportablelevelBodyXopqr_tY[] Level_ARRAY, Scopexportableheadersolid[] array_SCOPEXPORTABLEHEADERSOLID)
            {
