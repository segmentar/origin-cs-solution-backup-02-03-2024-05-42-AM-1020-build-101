...
namespace Core
{
    ...
    {
        public static ScopexportablemoduleBody Default(Scopexportableextractform[] array_SCOPEXPORTABLEEXTRACTFORM, Object[] array_OBJECT, Scopexportableheadersolid[] array_SCOPEXPORTABLEHEADERSOLID)
        {
