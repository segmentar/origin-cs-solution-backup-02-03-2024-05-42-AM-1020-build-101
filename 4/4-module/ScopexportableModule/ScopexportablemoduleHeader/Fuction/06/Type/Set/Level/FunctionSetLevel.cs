...
namespace Core
{
    ...
    public partial class ScopexportablemoduleHeader
    {
        ...
        {
            public static IList<ScopexportablelevelHeaderXopqrs_Y> FunctionLevelSet(ScopexportablelevelHeaderXopqr_tY[] Level_ARRAY)
            {
                ICollection<ScopexportablelevelHeaderXopqrs_Y> collectionResult = default;

                collectionResult = new Collection<ScopexportablelevelHeaderXopqrs_Y>();

                foreach (ScopexportablelevelHeaderXopqr_tY Level_VALUE in Level_ARRAY)
                {
                    ...
                    ScopexportablelevelHeaderXopqrs_Y level;

                    level = new ScopexportablelevelHeaderXopqrs_Y();
                ...
                return new List<ScopexportablelevelHeaderXopqrs_Y>(collectionResult);
            }
        }
    }
}
