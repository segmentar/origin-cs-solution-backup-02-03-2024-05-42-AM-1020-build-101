...
namespace Core
{
    ...
    public partial class ScopexportablemoduleHeader
    {
        ...
        {
            public static IList<ScopexportablelevelHeaderXopqr_tY> FunctionLevelSet(ScopexportablelevelHeaderXopq_stY[] Level_ARRAY)
            {
                ICollection<ScopexportablelevelHeaderXopqr_tY> collectionResult = default;

                collectionResult = new Collection<ScopexportablelevelHeaderXopqr_tY>();
                
                foreach (ScopexportablelevelHeaderXopq_stY Level_VALUE in Level_ARRAY)
                {
                    ...
                    ScopexportablelevelHeaderXopqr_tY level;

                    level = new ScopexportablelevelHeaderXopqr_tY();
                ...
                return new List<ScopexportablelevelHeaderXopqr_tY>(collectionResult);
            }
        }
    }
}
