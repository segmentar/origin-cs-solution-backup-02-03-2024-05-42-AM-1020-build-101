...
namespace Core
{
    ...
    public partial class ScopexportablemoduleHeader
    {
        ...
        {
            public static IList<ScopexportablelevelHeaderUopq_stV> FunctionLevelSet(ScopexportablelevelHeaderUop_rstV[] Level_ARRAY)
            {
                ICollection<ScopexportablelevelHeaderUopq_stV> collectionResult = default;

                collectionResult = new Collection<ScopexportablelevelHeaderUopq_stV>();

                foreach (ScopexportablelevelHeaderUop_rstV Level_VALUE in Level_ARRAY)
                {
                    ...
                    ScopexportablelevelHeaderUopq_stV level;

                    level = new ScopexportablelevelHeaderUopq_stV();
                ...
                return new List<ScopexportablelevelHeaderUopq_stV>(collectionResult);
            }
        }
    }
}
