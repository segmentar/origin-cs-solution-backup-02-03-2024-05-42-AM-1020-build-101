...
namespace Core
{
    ...
    public partial class ScopexportablemoduleHeader
    {
        ...
        {
            public static IList<ScopexportablelevelHeaderUop_rstV> FunctionLevelSet(ScopexportablelevelHeaderUo_qrstV[] Level_ARRAY)
            {
                ICollection<ScopexportablelevelHeaderUop_rstV> collectionResult = default;

                collectionResult = new Collection<ScopexportablelevelHeaderUop_rstV>();

                foreach (ScopexportablelevelHeaderUo_qrstV Level_VALUE in Level_ARRAY)
                {
                    Char[] characterArray;
                    ...
                    ScopexportablelevelHeaderUop_rstV level;

                    level = new ScopexportablelevelHeaderUop_rstV();
                ...
                return new List<ScopexportablelevelHeaderUop_rstV>(collectionResult);
            }
        }
    }
}
