...
namespace Core
{
    ...
    {
        public static IList<ScopexportablelevelHierarchyX_pqrstY> FunctionLevelSet(Scopexportableextractform[] array_SCOPEXPORTABLEEXTRACTFORM, Object[] array_OBJECT)
        {
