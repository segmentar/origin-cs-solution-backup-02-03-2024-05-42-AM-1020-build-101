...
namespace Core
{
    ...
    {
        public static IList<DirectoryInfo> ScopexportableioFolderSet(String Directory_VALUE, Boolean answer_SELF_should)
        {
            ...
            {
                var array = ScopexportableioFolderSetSurface(item, answer_SELF_should);
